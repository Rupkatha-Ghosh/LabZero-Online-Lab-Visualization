    ...
    <div className="relative min-h-full grainy pb-32">
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <header className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-12">
          ...
          >
            <div className="w-48 h-48 rounded-3xl flex items-center justify-center bg-black/20 backdrop-blur-xl border border-white/10 overflow-hidden shadow-2xl relative">
              {/* The theme is set to 'dark' to match your page's dark aesthetic */}
              <Subject3DCardModel 
